package com.aix0.customcrafting.recipes;

import com.aix0.customcrafting.CustomCrafting;
...
public class PickaxeRecipes {
    ...
    public void customPickaxeCrafting(){
        ...
        diamondPickaxeMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&2 Super Pickaxe"));
